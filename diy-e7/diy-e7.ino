 ...
 *  Whenever the board reset button is pressed, it will take an image, save it to the microSD card and go back to sleep to save power.
 *  This loop continues indefinitely. The microSD card needs to be formatted with the FAT32 file system.
 *
 *  By Frenoy Osburn
